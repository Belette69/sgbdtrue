...
class MysqlUserDao implements IUserDao
{
    ...
    private function insert(User $user)
    {
        ...
        $sql = "INSERT INTO sgbdtrue.secretariat (id, prenom, nom, email) 
    ...
    private function update(User $user)
    {
        ...
        $sql = "UPDATE sgbdtrue.secretariat SET prenom = :prenom, nom = :nom, gender = :gender, email = :email WHERE id = :id LIMIT 1";
    ...
    {
        $sql = "SELECT * FROM labosgbd1.users ORDER BY prenom, nom ASC";
